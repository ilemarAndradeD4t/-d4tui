...
export const isFormEdited = (form: UseFormReturn<any, any, any>) =>
  Boolean(!Object.entries(form.formState.dirtyFields).length);
...
function App() {
  const { characters, loadingCharacters, onSubmitCharactersTable } =
    useGetCharacters();

  const [images, setImages] = useState<IImage[]>([
    {
      data_url:
        "https://www.hmiscfl.org/wp-content/uploads/2018/06/generic-person-icon-14.png",
      imageId: "1234",
    },
    {
  ...
  const formPid = useForm<ILoginWithPID>({
    defaultValues: defaultLoginPID,
    resolver: zodResolver(pidLoginSchemaForm),
  });
  ...
  const FUELS: ComboxItem[] = [
    {
      id: "Gasolina",
      label: "Gasolina SUPER SPER ASDKAS ODASK DOASD ASD",
      value: Hydrocarbon.Gasoline,
    },
    {
      id: "Diesel",
      label: "Diesel SUPER DIESEL loREM IPSU",
      value: Hydrocarbon.Diesel,
    },
  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      const newImage = {
        data_url:
          "https://img.freepik.com/fotos-premium/imagen-fotografica-foto-stock-fondo-pantalla-hd-8k-hermosa-naturaleza-gratuita_915071-82095.jpg",
        imageId: "LO_QUE_SEA",
      };
    ...
    <ThemeProvider attribute="class" defaultTheme="light">
      <AppLayout>
        ...
        <div className="w-full">
          <Button onClick={() => openDialog()}>Agregar Carrier</Button>
          <FormCreateGPS />
        </div>
        ...
        <div className="grid">
          <div className="grid grid-cols-2">
            ...
            <div className="m-10">
              <Form {...probeForm}>
                <InputPID form={formPid} label="Cedula" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 mt-5 gap-x-2 gap-y-2">
                  ...
                  <GenericCombobox
                    ...
                    items={[
                      ...
                      { label: "Item 2", value: "ITEM_2", disabled: true },
                    ]}
                    ctaPlaceholder="Add"
                ...
                <Button className="m-5 bg-brand-primary hover:bg-brand-primary-opaque">
                  Primary button
                </Button>
              </Form>
            </div>
          ...
          <div className="my-20">
            <Dialog>
              <DialogTrigger>
                <Button>Abrir Modal con Imagen</Button>
              </DialogTrigger>
              <DialogContent className="flex justify-center items-center flex-col">
                <div className="flex justify-center items-center gap-x-6">
                  <D4TImage
                    zoom
                    download
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Documento_Espa%C3%B1ol.jpg/347px-Documento_Espa%C3%B1ol.jpg"
                  />
                  <D4TImage
                    zoom
                    src="https://happy-families.s3.ap-southeast-2.amazonaws.com/s3fs-public/styles/max_1300x1300/public/2021-09/Settle-down-about-selfies.jpg?VersionId=s9.37sTnWP4lwLl5TdYkISDea8UM6V4s&itok=pQEgg--h"
                  />
                </div>
